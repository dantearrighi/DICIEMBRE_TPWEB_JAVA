								...
								<fieldset>
							 		...
							 		<div class="control-group">
							  			<label class="control-label" for="oldconsumo">Consumo:</label>
							 				 <div class="controls">
												<input style=" color:black;" type="text" id="oldconsumo" name="oldconsumo" maxlength="50" value="<%=lavar.getConsumoEnergetico()%>" readonly/>
							  				</div>
									</div>
									
									<label class="control-label" for="consumo">Seleccionar nuevo Consumo energético</label>
								<div class="controls">
								  <p>
								  ...
								  <p>&nbsp;</p>
                                 	...
                                 	<div class="control-group">
							  			<label class="control-label" for="oldcolor">Color:</label>
							 				 <div class="controls">
												<input style="color:black;" type="text" id="oldcolor" name="oldcolor" maxlength="50" value="<%=lavar.getColor()%>" readonly/>
							  				</div>
									</div>
								  ...
								  <p>&nbsp;</p>
									...
									<div class="control-group">
							  			<label class="control-label" for="oldCarga">Carga:</label>
							 				 <div class="controls">
												<input style="color:black;" type="text" id="oldcarga" name="oldcarga" maxlength="50" value="<%=lavar.getCarga()%>" readonly/>
							  				</div>
									</div>
								
									<div class="control-group">
							  			<label class="control-label" for="carga">Nueva Carga:</label>
							 				 <div class="controls">
												<input type="text" id="carga" name="carga" maxlength="50" value="<%=lavar.getCarga()%>"/>
							  				</div>
									</div>
									...
									<div class="control-group">
							  			<label class="control-label" for="descripcion">Descripcion:</label>
							 				 <div class="controls">
												<input style="background-color:white; color:black;" type="text" id="descripcion" name="descripcion" maxlength="50" value="<%=lavar.getDescripcion()%>" />
							  				</div>
									</div>
									...
									<div class="control-group">
							  			<label class="control-label" for="peso">Peso:</label>
							 				 <div class="controls">
												<input type="text" id="peso" name="peso" maxlength="50" value="<%=lavar.getPeso()%>"/>
							  				</div>
									</div>
