...
<head>
  <meta charset="UTF-8">
  <title>Alta de Lavarropas</title>
      ...
      <div class="row-fluid sortable">
        <div class="box span12">
          <div class="box-header well" data-original-title>
            <h2><i class="icon-edit"></i> Alta de Lavarropas</h2>
            <div class="box-icon">
          ...
          <div class="box-content">
           <form name="datos" class="form-horizontal" action="ServletAddLavarropas" method="post" onsubmit="return validar();">
                                 ...
                                 <div class="controls">
                                   ...
                                   <p>&nbsp;</p>
							  			...
							  			<label class="control-label" for="carga">Carga:</label>
							 				 <div class="controls">
												<input type="text" id="carga" name="carga" maxlength="50" />
							  				</div>
									</div>
