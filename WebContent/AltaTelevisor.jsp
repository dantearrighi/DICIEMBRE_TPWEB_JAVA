...
if(session.getAttribute("usuario")==null)
	...
	ArrayList <Televisor> vListaTelevisor;
	ControladorTelevisorNegocio controladorTV = (ControladorTelevisorNegocio)session.getAttribute("controladorTelevisor");
	   
    vListaTelevisor = controladorTV.GetAllTe();
      ...
      <div class="row-fluid sortable">
        <div class="box span12">
          <div class="box-header well" data-original-title>
            <h2><i class="icon-edit"></i> Alta de Televisor</h2>
            <div class="box-icon">
          ...
          <div class="box-content">
           <form name="datos" class="form-horizontal" action="ServletAddTelev" method="post" onsubmit="return validar();">
              <div class="control-group">
								<label class="control-label" for="consumo">Consumo energ̩tico</label>
								<div class="controls">
								  <p>
                                ...
                                <div> 
                                 <label class="control-label" for="resolucion">Resolucion</label>
                                 <div class="controls">
                                 <input autofocus class="input-large span2" type="text" id="resolucion" name="resolucion">		  
              					 <p>&nbsp;</p>
              					</div>
                                
                                </div>
                                <div> 
                                <label class="control-label" for="sintonizador">Sintonizador</label>
                                <div class="controls">
                                <input type="checkbox" name="sintonizador" id="sintonizador">
                                </div>
                                 <p>&nbsp;</p>
                                </div>
