    ...
    <div id="content" class="span10">
      ...
      <div class="row-fluid sortable">
        <div class="box span12">
          ...
          <form name="datos" class="form-horizontal" action="ServletModificacionTelev" method="post" onsubmit="return validar();">
                ...
                <thead>
                  ...
                  <%for(int i=0; i<vListaTelevisores.size();i++){ %>
                    <tr>
                      ...
                      <td>
                      <input type="checkbox" name="idTelevSelected" value="<%=vListaTelevisores.get(i).getIdElect()%>">
					 </td>
...
<script type="text/javascript">
  function validar()
  {
	  var elementos = document.getElementsByName("idTelevSelected");
	  var bandera=false;
	  var cont=0;
      ...
      if(cont>1)
	  {
    	  falta += "Debe seleccionar sólo un televisor \n";
          fallo = true;
	  }
